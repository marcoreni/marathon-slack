...
function SlackHandler (options) {
    ...
    self.slackWebHook = options.slackWebHook;
    self.slackChannel = options.slackChannel;
    self.slackBotName = options.slackBotName;
    self.slackBotImage = options.slackBotImage;
...
SlackHandler.prototype.renderMessage = function (event) {
    ...
    function parseEvents (event) {
        ...
        if (self.slackBotName && self.slackBotName !== "") {
            message.username = self.slackBotName;
        }

        if (self.slackBotImage && self.slackBotImage !== "") {
            message["icon_url"] = self.slackBotImage;
        } 

        if (self.slackChannel && self.slackChannel !== "") {
            message["channel"] = self.slackChannel;
        } 
